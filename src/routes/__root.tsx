...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Lanavix texts back every missed call in 60 seconds, gets you 5-star reviews after every job, and finds 30 new leads in your area. Built for HVAC, plumbing, roofing, cleaning, and more." },
      ...
      { property: "og:description", content: "Stop losing $2,000/week to missed calls. Lanavix texts back every missed call in 60 seconds, automates review requests, and finds local leads — all without you lifting a finger." },
      ...
      { name: "twitter:description", content: "Stop losing $2,000/week to missed calls. Lanavix texts back every missed call in 60 seconds, automates review requests, and finds local leads automatically." },
